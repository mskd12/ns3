...
GetPosition (Ptr<Node> node)
{
  ...
  Time t = Simulator::Now();
  cout << t.GetSeconds() << " " << pos.x << " " << pos.y << endl;
  Simulator::Schedule (Seconds (1.0), &GetPosition, node);
}
...
// Configure mobility
  ...
  mobility.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Speed", StringValue ("ns3::UniformRandomVariable[Min=7.0|Max=9.0]"),
                             "Bounds", RectangleValue (Rectangle (0, 70, 0, 70)));

/*
  mobility.SetMobilityModel ("ns3::RandomWalk2dMobilityModel",
                             "Mode", StringValue ("Time"),
                             "Time", StringValue ("1s"),
                             "Speed", StringValue ("ns3::UniformRandomVariable[Min=6.0|Max=7.0]"),
                             "Bounds", RectangleValue (Rectangle (0, 70, 0, 70)));
...
//
  ...
  */
  ...
  //Simulator::Schedule(Seconds(0.1), &GetPosition, stas.Get(0));
