...
plot \
'./stats1.dat' using 1:3 with lines title "1", \
'./stats2.dat' using 1:3 with lines title "2", \
'./stats3.dat' using 1:3 with lines title "3", \
'./stats4.dat' using 1:3 with lines title "4", \
'./stats6.dat' using 1:3 with lines title "6", \
'./stats8.dat' using 1:3 with lines title "8"
